  ...
  <div class="container">
    <div class="row" style="margin-left: 10%;margin-right: 10%;">
      ...
      <div class="col-md-offset-1 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        ...
        <a href="/report" class="smoothScroll btn btn-success btn-lg wow fadeInUp" style="background-color: #f46d04;color:#14043c;border-color: #f46d04;" data-wow-delay="1.2s">Report now</a>
      </div>
