                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="today_plan" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="actual" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="tomorrow_plan" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="issues" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="action" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="2" class="form-control" name="note" style="width: 100%;" required></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <form action="edit_report" method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Today plan</label>
                                                            <textarea rows="2" class="form-control" name="today_plan" style="width: 100%;" required>{{$daily_report['today_plan']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Actual</label>
                                                            <textarea rows="2" class="form-control" name="actual" style="width: 100%;" required>{{$daily_report['actual']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Tomorrow plan</label>
                                                            <textarea rows="2" class="form-control" name="tomorrow_plan" style="width: 100%;" required>{{$daily_report['tomorrow_plan']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Issues</label>
                                                            <textarea rows="2" class="form-control" name="issues" style="width: 100%;"required>{{$daily_report['issues']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Action</label>
                                                            <textarea rows="2" class="form-control" name="action" style="width: 100%;" required>{{$daily_report['action']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Note</label>
                                                            <textarea rows="2" class="form-control" name="note" style="width: 100%;" required>{{$daily_report['note']}}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- onkeydown="return /[a-z, ]/i.test(event.key)" onblur="if (this.value == '') {this.value = '';}" onfocus="if (this.value == '') {this.value = '';}" -->
   ...
   <div style="margin-top: 1100px;"></div>
    <script>
        ...
        $(function() {
            ...
            console.log(check_today_report);
            var m = currentMonth + 1;
            var today = new Date();
            var i = today.getDate();
